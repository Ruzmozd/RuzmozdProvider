...
class BeginJobUseCase(private val jobProgressRepository: JobProgressRepository) {

    suspend operator fun invoke(jobId: Int): Flow<ApiResult<JobProgress>> = jobProgressRepository.beginJob(jobId)
