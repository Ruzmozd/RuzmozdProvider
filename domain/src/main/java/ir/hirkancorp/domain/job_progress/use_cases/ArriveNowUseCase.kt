...
class ArriveNowUseCase(private val jobProgressRepository: JobProgressRepository) {

    suspend operator fun invoke(jobId: Int): Flow<ApiResult<JobProgress>> = jobProgressRepository.arriveNow(jobId)
